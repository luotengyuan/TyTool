...
public final class ColorUtils {
     ...
     */
    public static int calculateMinimumAlpha(@ColorInt int foreground,
     ...
     */
    public static void blendHSL(@NonNull float[] hsl1,
                                @NonNull float[] hsl2,
                                @FloatRange(from = 0.0, to = 1.0) float ratio,
     ...
     */
    public static int setColorAlpha(@ColorInt int color,
