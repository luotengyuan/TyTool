...
public class MethodConstants {
    ...
    public static final String SET_ORDER_BY_CLAUSE = "setOrderByClause";

    public static final String GET_ORDER_BY_CLAUSE = "getOrderByClause";

    public static final String SET_DISTINCT = "setDistinct";

    public static final String IS_DISTINCT = "isDistinct";

    public static final String GET_ORED_CRITERIA = "getOredCriteria";
}
