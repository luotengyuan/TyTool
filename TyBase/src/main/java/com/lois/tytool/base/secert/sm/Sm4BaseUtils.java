...
public class Sm4BaseUtils {
    ...
    public void sm4SetkeyEnc(com.lois.tytool.base.secert.sm.Sm4ContextUtils ctx, byte[] key) throws Exception {
        if (ctx == null) {
    ...
    public void sm4SetkeyDec(com.lois.tytool.base.secert.sm.Sm4ContextUtils ctx, byte[] key) throws Exception {
        if (ctx == null) {
            throw new Exception("ctx is null!");
        }
    ...
    public byte[] sm4CryptEcb(com.lois.tytool.base.secert.sm.Sm4ContextUtils ctx, byte[] input) throws Exception {
        if (input == null) {
