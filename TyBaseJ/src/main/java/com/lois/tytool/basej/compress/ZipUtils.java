...
public class ZipUtils {
     ...
     */
    public static void zipFile(String filePath) throws ZipException {
     ...
     * @throws ZipException 异常
     */
    public static void zipFile(String filePath, String zipFilePath) throws ZipException  {
     ...
     * @throws ZipException 异常
     */
    public static void zipFile(String filePath, OutputStream outputStream) throws ZipException  {
        File file = new File(filePath);
     ...
     * @throws ZipException 异常
     */
    public static void zipFile(File file, File zipFile) throws ZipException  {
     ...
     * @throws ZipException 异常
     */
    public static void zipFile(File file, OutputStream outputStream) throws ZipException {
     ...
     * @throws ZipException 异常
     */
    public static void zipFile(String fileName, InputStream is, OutputStream os) throws ZipException {
     ...
     * @throws ZipException 异常
     */
    public static void zipFolder(String folder) throws ZipException {
     ...
     * @throws ZipException 异常
     */
    public static void zipFolder(String folder, String zipFilePath) throws ZipException {
        FileOutputStream fileOutputStream = null;
        try {
     ...
     * @throws ZipException 异常
     */
    public static void zipFolder(String folder, OutputStream outputStream) throws ZipException {
        File file = new File(folder);
        if (!file.isDirectory()) {
     ...
     * @throws ZipException 异常
     */
    private static void toZip(File[] files, ZipOutputStream zos, String entryPath) throws ZipException {
        try {
     ...
     * @throws ZipException 异常
     */
    public static void unzipFile(String zipFilePath) throws ZipException {
        File file = new File(zipFilePath);
        if (!file.isFile()) {
            throw new ZipException("路径【" + zipFilePath + "】不是一个文件");
        }
     ...
     * @throws ZipException 异常
     */
    public static void unzipFile(String zipFilePath, String unzipFolerPath) throws ZipException {
        File file = new File(zipFilePath);
        if (!file.isFile()) {
            throw new ZipException("路径【" + zipFilePath + "】不是一个文件");
        }
        ...
        if (!unzipFileDir.exists() || !unzipFileDir.isDirectory()) {
            ...
            if (!mkdirs) {
                throw new ZipException("创建文件路径【" + unzipFolerPath + "】失败");
            }
        }
            ...
            while(entries.hasMoreElements()) {
                ...
                if (entryFilePath.endsWith(File.separator)) {
                    ...
                    if (!dir.exists()) {
                        ...
                        if (!mkdir) {
                            throw new ZipException("创建路径【" + entryFilePath + "】失败");
                        }
                    }
                    continue;
                }
                ...
                if (!entryDir.exists() || !entryDir.isDirectory()) {
                    ...
                    if (!mkdirs) {
                        throw new ZipException("创建路径【" + entryDirPath + "】失败");
                    }
                }
                ...
                if (entryFile.exists() && !entryFile.isDirectory()) {
                    ...
                    if (!delete) {
                        throw new ZipException("删除文件【" + entryFilePath + "】失败");
                    }
                }
