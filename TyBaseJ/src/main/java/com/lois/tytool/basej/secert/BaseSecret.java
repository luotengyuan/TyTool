...
public final class BaseSecret {
    ...
    public static String getMessageDigest(String inStr,String keyStr, String encodeType){
        ...
        return com.lois.tytool.basej.util.HexUtils.bytesToHexString(messageDigest);
    }
    ...
    public static String keyGeneratorMac(String res, String algorithm, String key){
        ...
        return com.lois.tytool.basej.util.HexUtils.bytesToHexString(result);
    }
    /**
     * 使用KeyGenerator进行单向/双向加密（可设密码）
     * @param res 待加解密字节数组
    ...
    public String xoRencode(String res, String key) {
        ...
        return com.lois.tytool.basej.util.HexUtils.bytesToHexString(bs);
    }
