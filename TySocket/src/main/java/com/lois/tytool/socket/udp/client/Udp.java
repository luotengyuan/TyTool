...
import com.lois.tytool.socket.udp.client.listener.UdpClientListener;
import com.lois.tytool.socket.udp.client.manager.UdpSocketManager;
 ...
 * udp 客户端
 */
public class Udp extends BaseSocket {
    ...
    public static Udp getUdpClient() {
        Udp client = new Udp();
        client.init();
        return client;
    }
        ...
        for (UdpClientListener l : mUdpClientListeners) {
            ...
            if (listener != null) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        listener.onReceive(Udp.this, msg);
                    }
                });
            }
        }
        ...
        for (UdpClientListener l : mUdpClientListeners) {
            ...
            if (listener != null) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        listener.onSended(Udp.this, msg);
                    }
                });
            }
        }
        ...
        for (UdpClientListener l : mUdpClientListeners) {
            ...
            if (listener != null) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        listener.onError(Udp.this, msg, e);
                    }
                });
            }
        }
