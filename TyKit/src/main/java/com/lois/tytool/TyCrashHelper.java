...
/**
 * @Description 未捕获异常处理类,当程序发生未捕获异常的时候,由该类来接管程序,并记录发送错误报告.
 * @Author Luo.T.Y
 * @Date 2017-09-22
 * @Time 11:32
 ...
 * @see TyCrashActivity
 */
public final class TyCrashHelper {
    private static final String INTENT_EXTRA_STACK_TRACE = "com.lois.tytool.intent.EXTRA_STACK_TRACE";
    private static final String INTENT_EXTRA_URL = "com.lois.tytool.intent.EXTRA_URL";
     ...
     * 是否将异常信息记录到文件开关
     */
    public static boolean crashToFileSwitch = false;
    ...
    private static Class<? extends Activity> guessCrashActivityClass() {
        ...
        if (resolvedActivityClass == null && activityAvailable(TyCrashActivity.class)) {
            resolvedActivityClass = TyCrashActivity.class;
        }
     ...
     * @return 返回文件全路径
     */
    public static String saveException(String path, String ex) {
        try {
            long timestamp = System.currentTimeMillis();
            DateFormat mFormatter = new SimpleDateFormat("yyyy-MM-dd_HH-mm-ss");
    ...
    private static class MyUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
        ...
        public void uncaughtException(Thread thread, final Throwable throwable) {
            ...
            if (crashToFileSwitch) {
                Log.e(TAG, "Save stack trace: " + saveException(TyTool.getInstance().getAppDir() + "crash/", getDeviceInfo() + stackTraceString));
            }
