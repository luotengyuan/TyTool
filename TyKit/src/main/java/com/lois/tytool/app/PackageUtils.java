 ...
 * <li>{@link com.lois.tytool.app.PackageUtils#installNormal(Context, String)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#installSilent(Context, String)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#install(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Uninstall package</strong>
 * <li>{@link com.lois.tytool.app.PackageUtils#uninstallNormal(Context, String)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#uninstallSilent(Context, String)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#uninstall(Context, String)}</li>
 * </ul>
 * <ul>
 * <strong>Is system application</strong>
 * <li>{@link com.lois.tytool.app.PackageUtils#isSystemApplication(Context)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#isSystemApplication(Context, String)}</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#isSystemApplication(PackageManager, String)}</li>
 * </ul>
 * <ul>
 * <strong>Others</strong>
 * <li>{@link com.lois.tytool.app.PackageUtils#getInstallLocation()} get system install location</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#isTopActivity(Context, String)} whether the app whost
 * package's name is packageName is on the top of the stack</li>
 * <li>{@link com.lois.tytool.app.PackageUtils#startInstalledAppDetails(Context, String)} start
...
public final class PackageUtils {
     ...
     * @param context
     * @param filePath file path of package
     * @return {@link com.lois.tytool.app.PackageUtils#INSTALL_SUCCEEDED} means install success,
     * other means failed. details see {@link com.lois.tytool.app.PackageUtils}
    ...
    public static final int uninstall(Context context, String packageName) {
        if (com.lois.tytool.app.PackageUtils.isSystemApplication(context)
                || ShellUtils.checkRootPermission()) {
