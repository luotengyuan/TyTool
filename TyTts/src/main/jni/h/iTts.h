#ifndef MY_VOICE__TTS__H
#define MY_VOICE__TTS__H
...
ivTTS_CreateG(phTTS, pHeap, nHeapSize, pCBParam, pResPackDesc, nResPackCount,pUserInfo, MY_SDK_USERID)
...
ivTTS_CreateGecrypt(phTTS, pHeap, nHeapSize, pCBParam, pResPackDesc, nResPackCount,pUserInfo, MY_SDK_USERID)
