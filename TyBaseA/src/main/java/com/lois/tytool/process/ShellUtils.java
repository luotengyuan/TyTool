 ...
 * <li>{@link com.lois.tytool.process.ShellUtils#checkRootPermission()}</li>
 * </ul>
 * <ul>
 * <strong>Execte command</strong>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(String, boolean)}</li>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(String, boolean, boolean)}</li>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(List, boolean)}</li>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(List, boolean, boolean)}</li>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(String[], boolean)}</li>
 * <li>{@link com.lois.tytool.process.ShellUtils#execCommand(String[], boolean, boolean)}</li>
 * </ul>
 *
...
public final class ShellUtils {
     ...
     * @return
     * @see com.lois.tytool.process.ShellUtils#execCommand(String[], boolean, boolean)
     */
